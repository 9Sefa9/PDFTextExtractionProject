...
public abstract class Drawable implements PDFX {
    ...
    public Drawable(double x, double y, float width, float height, Color color, PDDocument pdfDocument, int pageNumber) {
        setX((float)x);
        setY((float)y);
        setWidth(width);
        setHeight(height);
    ...
    protected void setPdPage(PDPage pdPage) {
        this.pdPage = pdPage;
    }

    protected void setContentStream(PDPageContentStream contentStream) {
